    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_block', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='next_blocks', to='coinapp.block')),
                ('transactions', models.ManyToManyField(to='coinapp.transaction')),
            ],
        ),
    ]
